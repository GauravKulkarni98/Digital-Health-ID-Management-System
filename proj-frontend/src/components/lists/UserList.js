...
export default class UserList extends Component {
    ...
    addRecord(id) {
        this.props.history.push(`/add-record/${id}`); // history obj ->contains all the url mappings and is mantained by react router and passed down to the child with the help of props
    }
            ...
            <>
                <div>
                    ...
                    {/* {this.state.userarr.map((user) =>
                        <button className="btn btn-primary " onClick={this.addRecord(user.id)}> Add Your Information</button>
                    )} */}
                    </div>
                    <div className="row">
                                    ...
                                    this.state.userarr.map((user) =>
                                        <tr key={user.id}>
                                            ...
                                            <td>
                                                ...
                                                <button onClick={() => this.addRecord(user.id)} className="btn btn-info"> Add Your Information </button>
                                                {/* <button className="btn btn-primary " onClick={this.addRecord(user.id)}> Add Your Information</button> */}
                                            </td>
                                        </tr>
                                    )
